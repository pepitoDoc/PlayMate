    ...
    <div class="container">
        <div class="row text-center">
            <h1 class="my-lg-4 display-7 fw-bold ls-tight" style="color: hsl(0, 0%, 0%)">
                <img src="../../resources/logoPlayMate.png" class="img-fluid me-3" style="width: 100px; height: 100px;" alt="Responsive image">Play
        ...
        <div class="row">
          ...
          <div class="col-4 mt-4">
            <button id="botonEliminar" type="submit" class="btn btn-primary" style="width:200px; height:40px">Eliminar usuario</button>
          </div>
